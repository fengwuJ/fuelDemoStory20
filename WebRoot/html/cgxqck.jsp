			...
			<div id = "bottom">
				...
				<div id = "right">
					<div>
						...
						<div id = "juzhong">
							<button class="button2" onclick="window.location.href='shjl.jsp?tn=<%=tn %>'">审核记录</button>
							<button class="button2" onclick="window.location.href='cgsqcgxqlb.jsp'">返回</button>
						</div>
				  	</div>
				</div>		
			</div>	
